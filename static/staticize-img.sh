...
for size in 512 1024 2048 4096 8192; do
    ...
    cwebp -lossless -z 9 -m 6 -mt -alpha_filter best -af avatar${variant}-${size}x${size}.png -o avatar${variant}-${size}x${size}.webp
    ...
    cwebp -lossless -z 9 -m 6 -mt -alpha_filter best -af avatar-white-bg${variant}-${size}x${size}.png -o avatar-white-bg${variant}-${size}x${size}.webp
    ...
    cwebp -lossless -z 9 -m 6 -mt -alpha_filter best -af avatar-round${variant}-${size}x${size}.png -o avatar-round${variant}-${size}x${size}.webp
    ...
    cwebp -lossless -z 9 -m 6 -mt -alpha_filter best -af avatar-round-white-bg${variant}-${size}x${size}.png -o avatar-round-white-bg${variant}-${size}x${size}.webp
